...
- `metrics_stats_significance.py`: normality diagnostics (Shapiro-Wilk), non-parametric tests (Friedman + Nemenyi),
  pairwise Wilcoxon, Cliff's Delta, bootstrap CIs.

When normality holds, parametric RM-ANOVA + Tukey HSD can be used; otherwise, non-parametric tests are recommended by
default.
