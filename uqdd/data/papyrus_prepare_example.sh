...
today=$(date +%Y-%m-%d)
python data_papyrus.py --activity xc50 --sanitize --descriptor-chemical ecfp2048 --split-type scaffold_cluster --n-targets 20 --max-k-clusters 100 --recalculate True 2>&1 | tee ../logs/"${today}"_papyrus_xc50_20_ecfp2048.txt
